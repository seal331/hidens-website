...
# There used to be a bug where vice-versa would happen if someone had posted a comment to a blog post, or if a new blog post was added. which has since been fixed.
